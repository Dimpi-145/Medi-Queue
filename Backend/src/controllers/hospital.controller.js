...
async function hospitalCreatePatient(req, res) {
  try {
...
async function hospitalCreateDoctor(req, res) {
  try {
...
async function hospitalBookAppointment(req, res) {
  try {
...
module.exports = {
  getDashboardStats,
  getPatients,
  hospitalCreatePatient,
  walkInRegister,
  getDoctors,
  hospitalCreateDoctor,
  getAppointments,
